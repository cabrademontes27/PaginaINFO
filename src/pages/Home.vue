<template>
    ...
    <div class="home-container">
        ...
        <header :class="['header', { scrolled: isScrolled }]">
            ...
            <nav class="nav">
                <ul>
                    ...
                    <li>
                        <router-link to="/buscame" @click="closeNav"
                            >Buscame</router-link
                        >
                    </li>
                    <li>
        ...
        <div class="main-content">
            ...
            <section id="about" class="about">
                ...
                <p class="vision-text">
                    En Invisings imaginamos un mundo donde la accesibilidad
                    digital sea una realidad universal. Creemos firmemente que
                    la tecnología debe romper barreras, no crearlas. Nuestra
                    visión es ser pioneros en el desarrollo de soluciones que
                    empoderen a las personas con discapacidad visual para vivir
                    con plena autonomía y dignidad.
                </p>
    ...
    <div id="" class="information-content">
        <section class="information">
            <h2>Nuestra Misión en Invisings</h2>
            <p class="subheading">
                Transformando vidas a través de la tecnología accesible
            </p>
            ...
            <div class="info-cards">
                ...
                <div class="info-card">
                    ...
                    <h3>Innovación para la Independencia</h3>
                    <p>
                        Desarrollamos soluciones tecnológicas que empoderan a
                        personas con discapacidad visual para navegar el mundo
                        con confianza.
                    </p>
                </div>
                ...
                <div class="info-card">
                    ...
                    <h3>Tecnología Inclusiva</h3>
                    <p>
                        Nuestros productos utilizan sistemas de audio avanzados,
                        vibración táctil y compatibilidad completa con lectores
                        de pantalla.
                    </p>
                </div>
                ...
                <div class="info-card">
                    ...
                    <p>
                        Trabajamos directamente con usuarios finales para
                        asegurar que cada solución cumple con sus necesidades
                        reales.
                    </p>
                </div>
            </div>
            ...
            <div class="necessity-section">
                <div class="necessity-content">
                    ...
                    <div class="necessity-text">
                        <p>
                            Las estadísticas muestran que las personas con
                            discapacidad visual enfrentan:
                        </p>
                        <ul class="necessity-list">
                            <li>
                                <span class="icon">⚠️</span>Barreras diarias en
                                movilidad
                            </li>
                            <li>
                                <span class="icon">📉</span>Limitadas
                                oportunidades laborales
                            </li>
                            <li>
                                <span class="icon">💊</span>Dificultad en
                                gestión médica independiente
                            </li>
                        </ul>
            ...
            <div class="feature-section">
                <div id="information" class="feature-text">
                    ...
                    <p>
                        En <strong>Invisings</strong>, estamos comprometidos con
                        la creación de tecnología que transforma vidas. Nuestra
                        aplicación está diseñada específicamente para empoderar
                        a personas con discapacidad visual, ofreciendo
                        herramientas innovadoras que promueven la independencia,
                    ...
                    <ul class="feature-list">
                        <li>
                            <strong
                                >🦯 Funcionalidad para ubicación en tiempo
                                real:</strong
                            ><br />
                            Navega con confianza gracias a nuestro sistema de
                            guía en tiempo real. La app te proporciona
                            indicaciones precisas y alertas sobre obstáculos,
                            permitiéndote moverte de manera segura y autónoma.
                        </li>
                        <li>
                            <strong
                                >📖 Lector de medicamentos por cámara:</strong
                            ><br />
                            Simplifica tu día a día con nuestro lector de
                            medicamentos. Escanea el envase de tus medicamentos
                            con la cámara y la app te leerá en voz alta la
                            información importante, como la dosis y las
                            instrucciones.
                        </li>
                        <li>
                            <strong>🎧 Asistente por comandos de voz:</strong
                            ><br />
                            Controla la aplicación con tu voz. Nuestro asistente
                            de voz responde a tus comandos, permitiéndote
                            acceder a todas las funciones de manera rápida y sin
                            necesidad de tocar la pantalla.
                        </li>
                        <li>
                            <strong>📱 Aplicación con asistente de voz:</strong
                            ><br />
                            Una experiencia completamente accesible. Desde la
                            navegación hasta la lectura de textos, nuestro
                            asistente de voz está diseñado para adaptarse a tus
                            necesidades y hacerte la vida más fácil.
                        </li>
                    </ul>

                    <p>
                        En <strong>Invisings</strong>, creemos que la tecnología
                        debe ser inclusiva. Nuestra aplicación no solo es una
                        herramienta, sino un puente hacia un mundo más accesible
                        y conectado para todos.
                    </p>
                </div>
            ...
            <div id="team" class="team-section">
                ...
                <p class="team-description">
                    Un grupo diverso de ingenieros, diseñadores inclusivos y
                    especialistas en accesibilidad comprometidos con hacer la
                    diferencia.
                </p>
...
<style>
/* ------------------------------------------------------
   Remove "scoped" to ensure :root variables are global
------------------------------------------------------- */
...
.header {
    ...
    transition:
        ...
        padding 0.3s ease; /* Smooth transitions */
}
...
.nav.active::before {
    ...
    z-index: 998; /* Ensure it's below the nav but above other content */
}

.nav.active ul {
    z-index: 999; /* Ensure the menu is above the overlay */
}
